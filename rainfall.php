...
if (isset($_POST['startdate']) && isset($_POST['enddate']) &&  $date_timestamp1<= $date_timestamp2) {
    ...
    $response = file_get_contents('http://213.149.113.86:8000/api/measurement_by_date/?node_id=5&start_date=' . $startdate . '&end_date=' . $enddate . '');
}
    ...
    $startdate = date('d/m/Y', $old_date_timestamp);
    $today=date("d/m/Y");
    $response = file_get_contents('http://213.149.113.86:8000/api/measurement_by_date/?node_id=5&start_date=' . $startdate . '&end_date=' . $today . '');


}
else{
    $today=date("d/m/Y");
    $response = file_get_contents('http://213.149.113.86:8000/api/measurement_by_date/?node_id=5&start_date=' . $today . '&end_date=' . $today . '');
        ...
        window.onload = function () {
            ...
            var chart = new CanvasJS.Chart("chartContainer", {
                ...
                title: {
                    ...
                    ?>
                    text: "Rainfall (1h)  <?php echo $new_date; ?> "

                    <?php
                    }
                    else { ?>

                    text: "Rainfall (1h)  <?php echo $new_date; ?>-<?php echo $last_date; ?> "
                    <?php
            ...
            var chart2 = new CanvasJS.Chart("chartContainer2", {
                ...
                title: {
                    ...
                    if($date_timestamp3==$date_timestamp4){
                    ?>
                    text: "Rainfall (24h)  <?php echo $new_date; ?> "

                    <?php
                    }
                    else { ?>

                    text: "Rainfall (24h)  <?php echo $new_date; ?>-<?php echo $last_date; ?> "
                    <?php
...
<div class="wrapper">
    <div class="left">Rainfall info type
        <Select id="colorselector">
            <option value="yellow">Rainfall (24h)</option>
            <option value="red"> Rainfall (1h)</option>
