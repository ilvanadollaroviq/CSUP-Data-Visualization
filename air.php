...
if (isset($_POST['startdate']) && isset($_POST['enddate']) &&  $date_timestamp1<= $date_timestamp2) {
    ...
    $response = file_get_contents('http://213.149.113.86:8000/api/measurement_by_date/?node_id=3&start_date=' . $startdate . '&end_date=' . $enddate . '');
}
    ...
    $startdate = date('d/m/Y', $old_date_timestamp);
    $today=date("d/m/Y");
    $response = file_get_contents('http://213.149.113.86:8000/api/measurement_by_date/?node_id=3&start_date=' . $startdate . '&end_date=' . $today . '');


}
else{
    $today=date("d/m/Y");
    $response = file_get_contents('http://213.149.113.86:8000/api/measurement_by_date/?node_id=3&start_date=' . $today . '&end_date=' . $today . '');
    ...
    <script>
        window.onload = function () {
            ...
            var chart = new CanvasJS.Chart("chartContainer", {
                ...
                theme: "light2",
                title: {
                    <?php   $date_timestamp3 = strtotime($new_date);
                    $date_timestamp4 = strtotime($last_date);
                    if($date_timestamp3==$date_timestamp4){
                    ?>
                    text: "Air Temperature <?php echo $new_date; ?> "

                    <?php
                    }
                    else { ?>

                    text: "Air Temperature <?php echo $new_date; ?>-<?php echo $last_date; ?> "
                    <?php
            ...
            var chart2 = new CanvasJS.Chart("chartContainer2", {
                ...
                title: {
                    ...
                    if($date_timestamp3==$date_timestamp4){
                    ?>
                    text: "Air Humidity <?php echo $new_date; ?> "

                    <?php
                    }
                    else { ?>

                    text: "Air Humidity <?php echo $new_date; ?>-<?php echo $last_date; ?> "
                    <?php
            ...
            var chart3 = new CanvasJS.Chart("chartContainer3", {
                ...
                title: {
                    ...
                    if($date_timestamp3==$date_timestamp4){
                    ?>
                    text: "Air Pressure <?php echo $new_date; ?> "

                    <?php
                    }
                    else { ?>

                    text: "Air Pressure <?php echo $new_date; ?>-<?php echo $last_date; ?> "
                    <?php
...
<div class="wrapper">
    <div class="left">Air Information type
        <Select id="colorselector">
            <option value="blue">Pressure</option>
            <option value="red"> Temperature</option>
            <option value="yellow">Humidity</option>
        </Select>
    </div>
    <div class="right">
   ...
   <div class="rightt">
       <input type="button" class="button button5" onClick="Javascript:window.location.href = 'wind.php';" value="Wind" />
